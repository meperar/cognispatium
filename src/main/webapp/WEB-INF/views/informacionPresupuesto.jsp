        ...
        <div class="col-md-12" style="">
          <form action="<c:url value="/hello.htm" />"  method="POST">
           <div class="col-md-12 p-4" style="">
              <h1 class="bg-dark text-white text-center">Información presupuesto</h1>
              <h2><b> Datos solicitud</b> </h2>
              <h2> <b>Cliente:</b></h2>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
           ...
           <center>
           	<div class="col-md-12 text-center"><button type="reset" onclick="location.href='listadoPresupuestos.htm'" class="btn btn-primary w-25 text-center">Volver</button></div>
           </center>
          </form>
        </div>
      </div>
