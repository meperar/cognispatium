...
<body>
  <nav class="navbar navbar-light border-dark">
    <div class="container d-flex justify-content-center"> <a class="navbar-brand text-primary" href="#">
        ...
        <b class="text-dark"> PRESUPUESTO</b>
      </a> </div>
  </nav>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6" style="">
        <div class="form-group"><label contenteditable="true">Label&nbsp;</label></div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-3" style="">
  ...
  <div class="py-5">
    <div class="container">
      <div class="row">
        <div class="col-md-12 text-center"><a class="btn btn-primary text-center w-25" href="#">Pagar<br></a></div>
      </div>
    </div>
  </div>
  <div class="form-group"></div>
