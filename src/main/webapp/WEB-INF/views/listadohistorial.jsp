...
<body>
	...
	<div class="py-5">
		<div class="container">
			<div class="row">
				<form action="<c:url value="/historial.htm" />"
					method="GET">
					<div class="col-md-12" >
			...
			<div class="row">
				<div class="col-md-12">
					<table class="table">
						...
						<tbody>
							<c:forEach items="${model.historial}" var="historial">
								<form action="<c:url value="/historial.htm?hisId=${historial.id}" />" method="post" class="text-left">
									<tr>
										<td style="max-width: 500px;word-wrap:break-word;"><input type="hidden" id="solicitudId"
											name="solicitudId" value="${historial.id}">
											${historial.descripcion}</td>
										<td style="max-width: 500px;word-wrap:break-word;">${historial.descripcion}</td>
