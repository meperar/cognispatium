    ...
    <div class="container"> <button class="navbar-toggler navbar-toggler-right border-0" type="button" data-toggle="collapse" data-target="#navbar13">
      ...
      <table class="tablaFiltros" id="gh-sbc">
        <tbody>
          <tr>
            <td>
              <h3 class="gh-sbc-parent"><a title="" href=# class="titulosFiltros">Medicina<i class="gh-sbc-h3i gh-sprRetina"></i></a></h3>
              <ul>
              ...
              <h3 class="gh-sbc-parent"><a title="" href=# class="titulosFiltros">Deporte<i class="gh-sbc-h3i gh-sprRetina"></i></a></h3>
              <ul>
              ...
              <h3 class="gh-sbc-parent"><a title="" href=# class="titulosFiltros">Ciencia</h3>
              <ul>
            ...
            <td>
              <h3 class="gh-sbc-parent"><a title="" href=# class="titulosFiltros">Técnicos<i class="gh-sbc-h3i gh-sprRetina"></i></a></h3>
              <ul>
                <li><a class="scnd" href=#>Electricista</a></li>
                <li><a class="scnd" href=#>Fontanero</a></li>
              </ul>
              <h3 class="gh-sbc-parent"><a title="" href=# class="titulosFiltros">Legislación<i class="gh-sbc-h3i gh-sprRetina"></i></a></h3>
              <ul>
                <li><a class="scnd" href=#>Abogacía</a></li>
              </ul>
              <h3 class="gh-sbc-parent"><a title="" href=# class="titulosFiltros">Artes Marciales<i class="gh-sbc-h3i gh-sprRetina"></i></a></h3>
              <ul>
                <li><a class="scnd" href=#>Taekwondo</a></li>
                <li><a class="scnd" href=#>Aikido</a></li>
              </ul>
              <h3 class="gh-sbc-parent"><a title="" href=# class="titulosFiltros">Cuidados del Hogar<i class="gh-sbc-h3i gh-sprRetina"></i></a></h3>
              <ul>
            ...
            <td>
              <h3 class="gh-sbc-parent"><a title="" href=# class="titulosFiltros">Arte<i class="gh-sbc-h3i gh-sprRetina"></i></a></h3>
              <ul>
                <li><a class="scnd" href=#>Música</a></li>
                <li><a class="scnd" href=#>Pintura</a></li>
              </ul>
              <h3 class="gh-sbc-parent"><a title="" href=# class="titulosFiltros">Idiomas<i class="gh-sbc-h3i gh-sprRetina"></i></a></h3>
              <ul>
                <li><a class="scnd" href=#>Inglés</a></li>
                <li><a class="scnd" href=#>Español</a></li>
              </ul>
              <h3 class="gh-sbc-parent"><a title="" href=# class="titulosFiltros">Estética<i class="gh-sbc-h3i gh-sprRetina"></i></a></h3>
              <ul>
        ...
        <li class="nav-item" > <a class="nav-link" href="#" contenteditable="true">&nbsp;</a> </li>
      ...
      <div class="row">
        <div class="col-md-12">
          <p class="lead">CogniSpatium es la web donde solucionamos tus problemas. Déjanos tus dudas y las resolveremos enseguida.&nbsp;<br>También disponemos de personal bien formado a tu servicio.<br><br></p>
       	  <a href="https://imgur.com/tB4heUa"><img src="https://i.imgur.com/tB4heUa.jpg" title="source: imgur.com" /></a>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
