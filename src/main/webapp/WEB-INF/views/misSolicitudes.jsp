  ...
  <jsp:include page="barrasuperior.jsp" flush="true">
    <nav class="navbar navbar-dark bg-dark">
      <div class="container"> <a class="navbar-brand" href="#">
          ...
          <b>Mis Solicitudes<br></b>
        </a> </div>
    </nav>
    <div class="row">
      <div class="col-md-12">
        <c:foreach items="${solicitudes.solicitudes}" var="solicitud"></c:foreach>
          ...
          <tbody>
            <tr>
              ...
              <td><button class="bg-primary">
                  <i class="fas fa-plus-square" style="	background-image: url(https://pingendo.com/site-assets/cover.jpg);	background-position: top left;	background-size: 100%;	background-repeat: repeat;"></i>
                </button></td>
            </tr>
          </tbody>
          <tbody>
