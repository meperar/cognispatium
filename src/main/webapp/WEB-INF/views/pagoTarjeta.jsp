...
<body class="border border-dark">
	...
	<c:choose>
		<c:when test="${presupuestoId == null}">
			<form action="#" method="post">
		</c:when>
		<c:otherwise>
			<form action="<c:url value="/pagoTarjetaSolicitud.htm" />" method="post">
		</c:otherwise>
	</c:choose>
	<form action="#" method="post">
		<div class="py-0">
			<div class="container">
				<div class="row">
					<div class="col-md-6 p-5" style="">
						...
						<a class="btn btn-primary p-1 w-50" href="#">Tarjeta Credito</a><a
							class="btn btn-light w-50" href="#">PayPal<br></a>
						<div class="form-group">
							<label>Titular :&nbsp;</label> <input name="titular" type="text"
								class="form-control" placeholder="Introduza el titular"
								required="required">
						</div>
						<div class="form-group">
							<label>Numero de Tarjeta :&nbsp;</label> <input type="text"
								name="numTarjeta" pattern="[0-9]{16,}" required
								title="Introduzca 16 digitos" maxlength="16"
								class="form-control"
						...
						<div class="form-group">
							<label>CVV (?) :</label> <input name="cvv" type="text"
								pattern="[0-9]{3,}" required title="Introduzca 3 digitos"
						...
						<div class="row align-items-center">
							<div
								class="col-md-3 col-lg-3 m-0 d-inline-flex align-items-end flex-row-reverse justify-content-start text-right"
								style="">
								<input class="form-control w-25" placeholder="Type here"
									type="checkbox">
							</div>
							<div class="col-md-9 px-1" style="">
								<label class="text-left" style="">Guardar Información
									para operaciones futuras</label>
							</div>
						</div>
					</div>
				</div>
