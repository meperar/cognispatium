      ...
      <div class="row">
        ...
        <div class="col-md-7 p-4">
          ...
          <form action="#"  method="post" class="text-left">
            ...
            <div class="form-group"> <textarea name="respuesta" rows="3" placeholder="Tu respuesta a la consulta" required= "required" style="margin-top: 0px; margin-bottom: 0px; height: 141px;" ></textarea> </div> 
