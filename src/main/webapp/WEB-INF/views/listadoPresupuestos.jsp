...
<body >
  ...
  <jsp:include page="barrasuperior.jsp" flush="true">
    <div class="py-5">
      <div class="container">
        <div class="row">
          <form action="&lt;c:url value=" listadoconsultas.htm"="">" method="GET"&gt; <label for="form16">Servicio</label> <br> <select name="servicio">
              <option disabled="" selected="" value="">-- Seleccione un servicio --</option>
              <option value="${servicio.id}" label="${servicio.nombre}"></option>
              <option value="${servicio.id}" label="${servicio.nombre}" selected=""></option>
              <option value="${servicio.id}" label="${servicio.nombre}"></option>
            </select> <input class="btn btn-primary" type="submit" name="action" value="Filtrar">
          </form>
        </div>
        <br>
        <div class="row">
              ...
              <tbody>
                <tr>
                  ...
                  <td><button class="bg-primary">
                      <img src="https://image.flaticon.com/icons/svg/69/69321.svg" alt="magnifying glass icon free icon" title="magnifying glass icon free icon" width="20" height="20">
                    </button></td>
                </tr>
              </tbody>
            </table>
